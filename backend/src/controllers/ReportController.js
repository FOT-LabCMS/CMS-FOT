  ...
  try {
    ...
    const drawFullHeader = () => {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(13)
        .text("FOTCMS", marginLeft + 16, bannerY + 10);
    ...
    const drawCompactHeader = () => {
      ...
      doc
        ...
        .fontSize(9)
        .text(
          `FOTCMS  ·  ${data.canonicalName} (${data.chemicalCode})`,
          marginLeft + 14,
          bannerY + 9,
          { width: pageWidth * 0.7 },
        );
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          `Page ${i + 1} of ${range.count}   ·   Generated by FOTCMS — reflects stock levels at time of export.`,
          marginLeft,
  ...
  try {
    ...
    const drawUsageCompactHeader = () => {
      ...
      doc
        ...
        .fontSize(9)
        .text(
          `FOTCMS  ·  Usage Report  (${friendlyStart} — ${friendlyEnd})`,
          marginLeft + 14,
          bannerY + 9,
          { width: pageWidth * 0.7 },
        );
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          `Page ${i + 1} of ${range.count}   ·   Generated by FOTCMS — Usage data for period ${friendlyStart} to ${friendlyEnd}.`,
          marginLeft,
          doc.page.height - doc.page.margins.bottom - 14,
          { width: pageWidth, align: "center", lineBreak: false },
        );
  ...
  try {
    ...
    const drawInventoryCompactHeader = () => {
      ...
      doc
        ...
        .fontSize(9)
        .text(
          "FOTCMS  ·  Full Inventory Status Report",
          marginLeft + 14,
          bannerY + 9,
          { width: pageWidth * 0.7 },
        );
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          `Page ${i + 1} of ${range.count}   ·   FOTCMS — Faculty Laboratory Chemical Management System`,
          marginLeft,
          doc.page.height - doc.page.margins.bottom - 14,
          { width: pageWidth, align: "center", lineBreak: false },
        );
